...
<html lang="en">
  ...
  <body>
    ...
    <?php if(isset($_POST['submit'])){
      ...
      ////upload file ////
      $sql= "INSERT INTO san_pham_moi(id,ten_sp,gioi_thieu_sp,anh_sp,gia_sp) VALUES(NULL,'$ten_sp','$gioi_thieu_sp','$ten_file','$gia_sp')";
      mysqli_query($conn,"SET NAMES 'utf8'");
      $ok= mysqli_query($conn,$sql);
      if(isset($ok)) echo '<script>alert("Thêm vào trang thành công");</script>'; else echo '<script>alert("Thất bại, vui lòng thử lại!");</script>';
    }
    ?>
