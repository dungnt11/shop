...
<html lang="en">
  ...
  <body>
    <div class="container">
      <table class="table">
        <form method="POST" enctype="multipart/form-data">
          <h1 class="text-center">Sửa sản phẩm mới</h1>
          <tr>
            <td>Tên sản phẩm:</td>
    ...
    <?php if(isset($_POST['submit'])){
      ...
      ////upload file ////
      $id = $_GET['id_sp'];
      $sql= "UPDATE san_pham_moi SET ten_sp = '$ten_sp', gioi_thieu_sp = '$gioi_thieu_sp', anh_sp = '$ten_file', gia_sp = '$gia_sp' WHERE san_pham_moi.id = $id";
