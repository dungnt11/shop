...
<html lang="en">
  ...
  <body>
    <div class="container">
      <table class="table">
        <form method="POST" enctype="multipart/form-data">
          <h1 class="text-center">Thêm sản phẩm vào mục sản phẩm cũ</h1>
          <tr>
            <td>Tên sản phẩm:</td>
    ...
    <?php if(isset($_POST['submit'])){
      ...
      ////upload file ////
      $sql= "INSERT INTO san_pham_cu(id,ten_sp,gioi_thieu_sp,anh_sp,gia_sp) VALUES(NULL,'$ten_sp','$gioi_thieu_sp','$ten_file','$gia_sp')";
      mysqli_query($conn,"SET NAMES 'utf8'");
      $ok= mysqli_query($conn,$sql);
      if(isset($ok)) {echo '<script>alert("Thêm vào trang thành công!");</script>';
